...
public class BookDtoMapper {
    ...
    public Book convertToEntity(BookDto bookDto) {
        return new Book(bookDto.getId(), bookDto.getTitle(), bookDto.getAuthors(), bookDto.getDescription(), bookDto.getPrice(), bookDto.getPages(), bookDto.getCoverType(), bookDto.getGenre());
    }
